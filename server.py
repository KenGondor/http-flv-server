...
'''
Code and implementation is taken from: https://www.yanxurui.cc/posts/server/2017-11-25-http-flv/
This serves as a starting point to learn how http-flv is implmented and why its purported benefits are as such comapred to HLS/RTMP ...
'''
